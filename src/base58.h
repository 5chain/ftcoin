...
public:
    enum
    {
        PUBKEY_ADDRESS = 36,  // ftcoin addresses begin with 'F'
        SCRIPT_ADDRESS = 78, // ftcoin script addresses begin with 'Y'
...
public:
    ...
    bool IsValid() const
    {
        ...
        switch(nVersion)
        {
             case ((unsigned char)(128 + CBitcoinAddress::PUBKEY_ADDRESS)):
                break;

            case ((unsigned char)(128 + CBitcoinAddress::PUBKEY_ADDRESS_TEST)):
                fExpectTestNet = true;
                break;
