...
BOOST_INCLUDE_PATH=c:/libs/boost_1_55_0
BOOST_LIB_PATH=c:/libs/boost_1_55_0/stage/lib
BDB_INCLUDE_PATH=c:/libs/db-4.8.30.NC/build_unix
BDB_LIB_PATH=c:/libs/db-4.8.30.NC/build_unix
OPENSSL_INCLUDE_PATH=c:/libs/openssl-1.0.1q/include
OPENSSL_LIB_PATH=c:/libs/openssl-1.0.1q
...
# use: qmake "RELEASE=1"
contains(RELEASE, 1) {
    # Maf: compile for maximum compatibility (10.5, 32-bit)
